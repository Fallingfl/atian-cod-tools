...
namespace {
	...
	void bo4_event_tool() {
		...
		static const char* op1s[]{
			...
			"season_2_stream",
            "eason_2_bonus_stream",
            "eason_3_stream",
            "eason_3_starter_pack",
            "eason_4_starter_pack",
            "eason_4_stream",
            "arly_season_4_loot_drop",
            "eason_5_stream",
            "ummer_break_bundle",
            "ourth_of_july_event_stream",
            "season_6_stream",
            "eason_7_stream",
            "abor_day_event_stream",
            "season_8_stream",
            "eason_9",
            "m_lab_titanium_treble_slot_1",
            "digital_refresh_v3",
            "eserves_drop_12",
            "unset_features",
            "bribe_offer_launch",
